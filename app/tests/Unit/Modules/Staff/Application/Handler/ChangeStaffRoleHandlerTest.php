...
final class ChangeStaffRoleHandlerTest extends TestCase
{
    public function testItChangesStaffRole(): void
    {
        ...
        $handler = new ChangeStaffRoleHandler($repository);
        $response = $handler(new ChangeStaffRoleCommand('019eec93-9a11-7432-bd04-52306b2b3d00', $academyId->value(), $assignment->id()->value(), new StaffRole(StaffRole::ASSISTANT_COACH)));
        self::assertSame(StaffRole::ASSISTANT_COACH, $response->toArray()['role']);
    }
}
