...
final readonly class ReplacePlayerDocumentHandler
{
    ...
    {
        $academy = new AcademyId($command->academyId); $document = $this->repository->findActiveById($academy, new PlayerId($command->playerId), new PlayerDocumentId($command->documentId)) ?? throw new PlayerDocumentNotFoundException();
