...
final class ChargeController extends AbstractApiController
{
    ...
    {
        $items = ($this->listPendingHandler)(new ListPendingChargesQuery($this->tenantContext->requireAcademyId()));
