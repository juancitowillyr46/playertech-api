...
final readonly class ChargeResponse
{
    ...
    public function toArray(): array { return ['id'=>$this->id,'membership_id'=>$this->membershipId,'payment_concept_id'=>$this->paymentConceptId,'description'=>$this->description,'amount'=>$this->amount,'status'=>$this->status]; }
}
