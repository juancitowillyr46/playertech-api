...
final readonly class PaymentConceptResponse
{
    ...
    public function toArray(): array { return ['id'=>$this->id,'academyId'=>$this->academyId,'code'=>$this->code,'name'=>$this->name,'description'=>$this->description,'status'=>$this->status];}
}
