...
final readonly class PaymentConceptResponse
{
    ...
    public static function fromPaymentConcept(PaymentConcept $paymentConcept): self
    {
        return new self(
            $paymentConcept->id()->value(),
            $paymentConcept->academyId()->value(),
            $paymentConcept->code(),
            $paymentConcept->name(),
            $paymentConcept->description(),
            $paymentConcept->status()->value(),
        );
    }
