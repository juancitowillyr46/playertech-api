...
- `docs/flows/`
  - Propósito: flujos funcionales de negocio que combinan contrato, UX y ejecución.
  - Fuente: backlog, API reference y memoria persistente.
  - Riesgo: medio si se confunde con el dominio puro.
- `specs/<dominio>/`
