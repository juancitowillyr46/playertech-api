...
La convención general de respuestas y errores está definida en `docs/contracts/api-principles.md`.
...
`docs/contracts/api-principles.md` conserva el marco general de la API, pero las decisiones de contrato ya estabilizadas deben vivir aquí para evitar duplicidad.
