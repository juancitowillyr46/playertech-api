...
quiero consultar el catálogo oficial de tipos de documento,
para seleccionar valores válidos y consistentes en jugadores, acudientes, importaciones y documentos asociados.

---

## Contexto de negocio

Los tipos de documento son utilizados por más de una funcionalidad del sistema. El backend debe ofrecer una fuente única para que los consumidores no tengan que mantener listas duplicadas de valores y etiquetas.
...
1. El cliente solicita el catálogo de tipos de documento.
...
5. El cliente utiliza las opciones en formularios, importaciones o documentos.
...
**Cuando** solicita el catálogo de tipos de documento
...
**Dado** que el catálogo contiene tipos de documento
...
**Dado** que Player o LegalGuardian requieren un tipo de documento
...
- Futuras funcionalidades que requieran tipos de documento.
