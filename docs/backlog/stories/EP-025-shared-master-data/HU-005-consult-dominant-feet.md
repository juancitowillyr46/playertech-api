...
quiero consultar el catálogo oficial de pies dominantes,
...
El pie dominante puede utilizarse en formularios, importaciones y respuestas enriquecidas del jugador. El backend debe ofrecer una fuente única para evitar listas paralelas entre módulos y clientes.
...
- Consultar los pies dominantes disponibles.
...
- Crear, editar o eliminar pies dominantes.
...
1. El cliente solicita el catálogo de pies dominantes.
...
**Cuando** solicita el catálogo de pies dominantes
...
**Dado** que el catálogo contiene pies dominantes
...
**Dado** que Player u otras funcionalidades requieren un pie dominante
...
- Futuras funcionalidades que requieran pie dominante cerrado.
