...
quiero consultar el catálogo oficial de géneros,
...
El género puede utilizarse en formularios, importaciones y respuestas enriquecidas del jugador. El backend debe ofrecer una fuente única para evitar listas paralelas entre módulos y clientes.
...
- Crear, editar o eliminar géneros.
...
1. El cliente solicita el catálogo de géneros.
...
**Cuando** solicita el catálogo de géneros
...
**Dado** que el catálogo contiene géneros
...
**Dado** que Player u otras funcionalidades requieren un género
...
- Futuras funcionalidades que requieran género cerrado.
