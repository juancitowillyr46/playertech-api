...
Quiero registrar usuarios administrativos

Para delegar responsabilidades operativas dentro de la academia.

---

# Valor de Negocio

Reducir la dependencia de una sola persona para administrar la academia.
...
Todo usuario debe pertenecer a una academia.
