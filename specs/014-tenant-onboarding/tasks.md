...
- [ ] T001 Validate tenant onboarding documentation against `specs/14-current-state.md`
- [ ] T002 Align tenant onboarding backlog stories with the feature scope in `spec.md`

## Phase 2: Foundational

- [ ] T003 Map current onboarding endpoints to the canonical feature
- [ ] T004 Consolidate duplicated onboarding stories and references
