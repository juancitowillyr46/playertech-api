...
- [ ] T001 Validate academy documentation against `specs/14-current-state.md`
- [ ] T002 Align academy backlog stories with the feature scope in `spec.md`

## Phase 2: Foundational

- [ ] T003 Map current academy endpoints to the canonical academy feature
- [ ] T004 Consolidate conflicting academy stories in the backlog
