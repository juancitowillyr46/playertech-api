# Checklist de calidad de especificación: Catálogo compartido de parentescos
...
- [x] Los requisitos son verificables y suficientemente explícitos.
...
- [x] La compatibilidad con cualquier endpoint existente está explicitada como reemplazo de ruta.
- [x] La especificación está lista para planificación respecto a las decisiones de rutas y autorización.

## Notas

- La ruta oficial es `/api/v1/academy/relationships/options`.
